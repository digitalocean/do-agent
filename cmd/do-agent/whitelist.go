...
var gpuWhitelist = map[string]bool{
	...
	"DCGM_FI_DEV_NVLINK_CRC_FLIT_ERROR_COUNT_TOTAL": true,
	"DCGM_FI_DEV_NVLINK_CRC_DATA_ERROR_COUNT_TOTAL": true,
	"DCGM_FI_DEV_NVLINK_REPLAY_ERROR_COUNT_TOTAL":   true,
	"DCGM_FI_DEV_NVLINK_RECOVERY_ERROR_COUNT_TOTAL": true,
