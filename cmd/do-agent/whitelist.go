...
var gpuWhitelist = map[string]bool{
	...
	"amd_gpu_ecc_correct_total":                              true,
	...
	"amd_gpu_violation_processor_hot_residency_accumulated":  true,
	"amd_gpu_violation_soc_thermal_residency_accumulated":    true,
	"amd_gpu_violation_current_accumulated_counter":          true,
	...
	"amd_gpu_violation_socket_thermal_residency_accumulated": true,
	"amd_gpu_violation_vr_thermal_residency_accumulated":     true,
	"amd_gpu_junction_temperature":                           true,
	"amd_gpu_power_usage":                                    true,
	"amd_gpu_package_power":                                  true,
