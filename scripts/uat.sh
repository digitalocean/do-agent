...
SUPPORTED_IMAGES["debian-10-x64"]="60461760"
...
SUPPORTED_IMAGES["fedora-31-x64"]="56521921"
...
function command_create_status() {
	list \
		...
		| GREP_COLOR='1;31' egrep --color=yes 'new|$' \
		| GREP_COLOR='1;32' egrep --color=yes 'active|$'
}
